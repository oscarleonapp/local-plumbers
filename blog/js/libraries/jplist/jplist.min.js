            ...
            value: function(e) {
                ...
                e.element.addEventListener("jplist.state", function(o) {
                    if (n && o.jplistState) {
                        ...
                        "dynamic" === e.mode && o.jplistState.filtered && o.jplistState.filtered.length > 0 && (i = t.getDynamicCounterValue(n, e.filterType, o.jplistState.filtered)),
                        r.render(i)
                    }
                }, !1)
            }
            ...
            value: function(e) {
                ...
                try {
                    for (var o, i = this.controls[Symbol.iterator](); !(t = (o = i.next()).done); t = !0) {
                        ...
                        a.element.classList.add("jplist-selected")) : (a.selected = !1,
                        a.element.classList.remove("jplist-selected"))
                    }
                } catch (e) {
                    r = !0,
    ...
    var l = function(e) {
        ...
        o(t, [{
            ...
            value: function(e) {
                ...
                e.element.addEventListener("jplist.state", function(t) {
                    if (t.jplistState) {
...
, function(e, t, r) {
    ...
    var l = function(e) {
        function t(e) {
            ...
            r.selectedClass = (e.getAttribute("data-selected-class") || "jplist-selected").trim()),
            r
        }
        return function(e, t) {
            if ("function" != typeof t && null !== t)
