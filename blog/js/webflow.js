...
, function(t, e, n) {
    ...
    window.tram = function(t) {
        ...
        var N = e.frame = function() {
          ...
          , j = l(function(t) {
            ...
            t.init = function(t, e, n, i) {
                ...
                this.string = this.name + L + this.duration + "ms" + ("ease" != this.ease ? L + f[this.ease][0] : "") + (this.delay ? L + this.delay + "ms" : ""))
            }
            ,
            t.set = function(t) {
        ...
        z.transform && z.backface && (Z.z = [x, "translateZ"],
        Z.rotateZ = [k],
        Z.scaleZ = [b],
        Z.perspective = [y]);
        var Q = /ms/
...
, function(t, e, n) {
    ...
    r.define("forms", t.exports = function(t, e) {
        var n, o, a, s, u, c = {}, l = t(document), f = window.location, d = window.XDomainRequest && !window.atob, h = ".w-form", p = /e(-)?mail/i, v = /^\S+@\S+$/, m = window.alert, w = r.env(), b = /list-manage[1-9]?.com/i, g = e.debounce(function() {
        ...
        function y(e, n) {
            ...
            r.fileUploads.each(function(e) {
                !function(e, n) {
                    if (!n.fileUploads || !n.fileUploads[e])
                        return;
                    var i, r = t(n.fileUploads[e]), o = r.find("> .w-file-upload-default"), a = r.find("> .w-file-upload-uploading"), s = r.find("> .w-file-upload-success"), c = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"), f = o.find(".w-file-upload-label"), d = f.children(), h = c.find(".w-file-upload-error-msg"), p = s.find(".w-file-upload-file"), v = s.find(".w-file-remove-link"), m = p.find(".w-file-upload-file-name"), b = h.attr("data-w-size-error"), g = h.attr("data-w-type-error"), y = h.attr("data-w-generic-error");
                    w || f.on("click keydown", function(t) {
                        "keydown" === t.type && 13 !== t.which && 32 !== t.which || (t.preventDefault(),
                        l.click())
                    });
                    if (f.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"),
                    ...
                    function _(t) {
                        var i = t.responseJSON && t.responseJSON.msg
                          , r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = g : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = b),
                        h.text(r),
                        l.removeAttr("data-value"),
                        l.val(""),
                        a.toggle(!1),
            ...
            b.test(c) ? r.handler = A : c || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : _ : g())
        }
        function x(t) {
...
, function(t, e, n) {
    ...
    i.define("slider", t.exports = function(t, e) {
        var n, s, u, c = {}, l = t.tram, f = t(document), d = i.env(), h = ".w-slider", p = '<div class="w-slider-dot" data-wf-ignore />', v = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', m = "w-slider-force-show", w = r.triggers, b = !1;
        function g() {
            (n = f.find(h)).length && (n.each(k),
            u || (y(),
            i.resize.on(x),
        ...
        function k(e, n) {
            ...
            r.nav.off(h),
            E(r),
            s ? (r.el.on("setting" + h, z(r)),
            M(r),
            r.hasTimer = !1) : (r.el.on("swipe" + h, z(r)),
            r.left.on("click" + h, O(r)),
            r.right.on("click" + h, T(r)),
            r.left.on("keydown" + h, L(r, O)),
            r.right.on("keydown" + h, L(r, T)),
        ...
        function A(e, n, i) {
            return function(r) {
                ...
                e.hasTimer && M(e)) : (e.ariaLiveLabel.attr("aria-live", "off"),
                e.hasTimer && S(e))
            }
        }
        function L(t, e) {
            ...
            return function(r, a) {
                ...
                if (s && "setting" === r.type) {
                    ...
                    if ("swipe" === r.type) {
                        ...
                        if (i.env("editor"))
                            return;
                        return "left" === a.direction ? T(n)() : "right" === a.direction ? O(n)() : void 0
                    }
                    if (n.nav.has(r.target).length) {
                        ...
                        "keydown" === r.type)
                            ...
                            case o.ARROW_LEFT:
                            case o.ARROW_UP:
                                C(n.nav, Math.max(c - 1, 0)),
                                r.preventDefault();
                                break;
                            case o.ARROW_RIGHT:
                            case o.ARROW_DOWN:
                                C(n.nav, Math.min(c + 1, n.pages)),
                                r.preventDefault();
                                break;
                            case o.HOME:
                                C(n.nav, 0),
